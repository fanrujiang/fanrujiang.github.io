import{_ as n,o as s,c as e,e as a}from"./app-rjaaUb-0.js";const i={},c=a(`<h1 id="宝塔nginx缓存清理" tabindex="-1"><a class="header-anchor" href="#宝塔nginx缓存清理" aria-hidden="true">#</a> 宝塔Nginx缓存清理</h1><p>在工作中使用宝塔部署项目时，我发现宝塔会奇怪地缓存接口的数据。经过排查，发现只有设置了响应头包含 <code>Cache-Control</code> 的接口才会被宝塔Nginx的反向代理缓存。</p><p>于是，我开始着手解决这个问题。</p><p>首先，我找到了宝塔Nginx中反向代理的配置文件和缓存目录。一旦确定了位置，解决思路也就清晰了。</p><h2 id="步骤一-删除缓存目录中的文件" tabindex="-1"><a class="header-anchor" href="#步骤一-删除缓存目录中的文件" aria-hidden="true">#</a> 步骤一：删除缓存目录中的文件</h2><p>反向代理的缓存目录位于：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>/www/server/nginx/proxy_cache_dir
