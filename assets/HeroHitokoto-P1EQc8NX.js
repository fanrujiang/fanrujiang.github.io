import{a as v}from"./axios-QLjAsgXu.js";import{i as k,G as x,Q as p,j as g,r as y,o as E,g as T,w as H,a as I,_ as w}from"./app-rjaaUb-0.js";const B=I("div",{class:"none"},"一言插件",-1),C=k({__name:"HeroHitokoto",setup(M){let h="https://v1.hitokoto.cn";const _=e=>{const t=window;clearInterval(t.Timer);const o=document.getElementsByClassName("vp-blog-hero-description");if(o.length>0){const d=o[0];d.id="hotWord"}const m=document.getElementById("hotWord");if(!m)return;m.innerHTML=`
<div class="word">
  <div class="left">『</div>
