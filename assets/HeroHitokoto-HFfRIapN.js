import{a as _}from"./axios-QLjAsgXu.js";import{i as v,G as g,P as f,j as x}from"./app-mQe7tUFU.js";import{_ as k}from"./plugin-vue_export-helper-x3n3nnut.js";const y=v({__name:"HeroHitokoto",setup(E){const p=o=>{const t=window;clearInterval(t.Timer);const n=document.getElementsByClassName("vp-blog-hero-description");if(n.length>0){const m=n[0];m.id="hotWord"}const d=document.getElementById("hotWord");if(!d)return;d.innerHTML=`
<div class="word">
  <div class="left">『</div>
