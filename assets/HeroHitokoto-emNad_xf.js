import{a as _}from"./axios-QLjAsgXu.js";import{h as v,E as g,N as f,i as x}from"./app-gulTYumw.js";import{_ as k}from"./plugin-vue_export-helper-x3n3nnut.js";const E=v({__name:"HeroHitokoto",setup(y){const p=o=>{const t=window;clearInterval(t.Timer);const n=document.getElementsByClassName("vp-blog-hero-description");if(n.length>0){const m=n[0];m.id="hotWord"}const d=document.getElementById("hotWord");if(!d)return;d.innerHTML=`
<div class="word">
  <div class="left">『</div>
